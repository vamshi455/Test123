...
FROM (
    ...
    FROM (
        SELECT
            ...
            SUM(OIL_VOLUME_RES_BBL) AS OIL_VOLUME_RES_BBL,
            SUM(WATER_VOLUME_RES_BBL) AS WATER_VOLUME_RES_BBL,
            SUM(WATER_INJ_VOLUME) AS WATER_INJ_VOLUME_STB,
            SUM(WATER_INJ_VOLUME_RES_BBL) AS WATER_INJ_VOLUME_RES_BBL,
            ...
            SUM(GAS_INJ_VOLUME_RES_BBL) AS GAS_INJ_VOLUME_RES_BBL,
            SUM(OIL_VOLUME_RES_BBL) + SUM(WATER_VOLUME_RES_BBL) + SUM(FREE_GAS) AS PRODUCTION_VOLUME_RES_BBL,
            ...
            SUM(WATER_INJ_VOLUME_RES_BBL + GAS_INJ_VOLUME_RES_BBL) AS INJECTION_VOLUME_RES_BBL,
            SUM(WATER_INJ_VOLUME_RES_BBL + GAS_INJ_VOLUME_RES_BBL) OVER (PARTITION BY ID_PATTERN ORDER BY DATE ASC) AS CUMULATIVE_INJECTION_VOLUME_RES_BBL,
 ...
 >>
            ...
            SELECT
                ...
                COALESCE(daily_volume.ALLOC_GAS_VOL_KSCF * 1000 * split_factors.FACTOR, daily_volume.ALLOC_GAS_VOLifle:///Users/abhisheksingh/Downloads/InterpolatePVTCompletionTest_Working.sqlKSCF * 1000, 0) AS GAS_WELL_GAS_VOLUME,
                ...
                CASE
                    WHEN daily_volume.THEOR_OIL_VOL_STB IS NOT NULL OR daily_volume.THEOR_GAS_VOL_KSCF IS NOT NULL THEN 
                        COALESCE(
                    ...
                    ELSE 0
                END AS FREE_GAS,
                COALESCE(daily_volume.THEOR_OIL_VOL_STB * split_factors.FACTOR * pvt.OIL_FORMATION_VOLUME_FACTOR, daily_volume.THEOR_OIL_VOL_STB * pvt.OIL_FORMATION_VOLUME_FACTOR, 0) AS OIL_VOLUME_RES_BBL,
                COALESCE(daily_volume.THEOR_WATER_VOL_STB * split_factors.FACTOR * pvt.WATER_FORMATION_VOLUME_FACTOR, daily_volume.THEOR_WATER_VOL_STB * pvt.WATER_FORMATION_VOLUME_FACTOR, 0) AS WATER_VOLUME_RES_BBL,
                COALESCE(daily_volume.THEOR_WATER_INJ_VOL_STB * split_factors.FACTOR * pvt.INJECTED_WATER_FORMATION_VOLUME_FACTOR, daily_volume.THEOR_WATER_INJ_VOL_STB * pvt.INJECTED_WATER_FORMATION_VOLUME_FACTOR, 0) AS WATER_INJ_VOLUME_RES_BBL,
                COALESCE(daily_volume.THEOR_GAS_INJ_VOL_KSCF * 1000 * split_factors.FACTOR * pvt.INJECTED_GAS_FORMATION_VOLUME_FACTOR, daily_volume.THEOR_GAS_INJ_VOL_KSCF * 1000 * pvt.INJECTED_GAS_FORMATION_VOLUME_FACTOR, 0) AS GAS_INJ_VOLUME_RES_BBL,
